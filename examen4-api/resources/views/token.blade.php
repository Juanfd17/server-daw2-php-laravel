...
<head>
    ...
    <style>
        .mi-boton{display:flex;align-items:center;justify-content:center;height:100vh;flex-direction: column}.icon-button{display:flex;align-items:center;justify-content:center;padding:20px;font-size:20px;background-color:#9ca3af;color:#000;border:none;cursor:pointer;border-radius:10px;transition:background-color 0.3s ease}.icon-button:hover{background-color:#718096}.icon{margin-right:10px}.text{font-size:1.2em}#ver-token{font-size: 1.5em; margin-top: 20px; text-align: center; color:#2d3748}
    </style>
...
<div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
    ...
    @endif
        ...
        <div class="mi-boton">
            <button id="crear-token" class="icon-button">
                ...
                <span class="text">Crear token</span>
            </button>
...
<script>
    let crearToken = document.querySelector("#crear-token")
    crearToken.addEventListener("click", () =>{
        ...
        fetch("http://127.0.0.1:8000/crearToken", requestOptions)
            .then((response) => response.json())
            .then((result) => {
                console.log(result)
                let verId = document.querySelector("#ver-token")
                verId.innerHTML = result.token
            })
